...
public class A_Break {
	 ...
	 *             switch문 내부에 있는 break는 swith문을 빠져나가는 용도로 사용
	 *             
	...
	public void method2() {
		...
		while(true) {
			System.out.println("아무거나 쓰세요(단, 종료를 원하신다면 'exit'을 입력해주세요.)");
	...
	// 만약에 입력한 숫자가 0보다 작다면 "프로그램을 종료합니다."라는 문구를 출력하고 종료하시오!
	...
	public void method3() {
		...
		while(true) {
			System.out.print("정수값을 입력해주세요(음수입력시 종료.) > ");
			int num = sc.nextInt();

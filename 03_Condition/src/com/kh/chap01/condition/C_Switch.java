...
public class C_Switch {
	 ...
	 * 
	 * switch(정수 || 실수 || 문자 || 문자열) {
	 * case 값1 : 실행할 코드a; // 동등비교대상 == 값1 true일 경우 실행할코드 a를 수행
	 * break;
	 * case 값2 : 실행할 코드b; // 동등비교대상 == 값2 true일 경우 실행할코드 b를 수행
	 * break;
	 * case 값n : 실행할 코드n; // 동등비교대상 == 값n true일 경우 실행할코드 n을 수행
	 * break;
	 * default : 실행할코드; // == else
	 * }
	 */
	...
	public void method1() {
		...
		Scanner sc = new Scanner(System.in);
		System.out.print("메뉴를 선택해주세요(부대찌개, 떡갈비, 제육볶음, 칼국수, 수제비) > ");
		String menu = sc.nextLine();
		//System.out.println(menu);
		
		/*switch(menu) {
		case "부대찌개" : System.out.println("11,000원 입니다."); break;
		case "떡갈비"  : System.out.println("13,000원 입니다."); break;
		case "칼국수"  : System.out.println(" 8,000원 입니다."); break;
		case "제육볶음" : System.out.println(" 7,000원 입니다."); break;
		case "수제비"  : System.out.println(" 7,000원 입니다."); break;
		default : System.out.println("메뉴를 확인해주세요.");
		}*/
		// 중복제거하기
		// 1. 중복된 부분은 하나로 빼기
		// 2. 중복이 아닌 부분은 변수로 처리
	...
	public void login() {
		...
		// 만약에 사용자가 로그인 시 입력한 아이디값과 회원가입시 가입한 아이디 값이 동일하고

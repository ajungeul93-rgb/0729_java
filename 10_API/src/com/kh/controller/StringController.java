...
public class StringController {
	...
	public void method1() {
		...
		Run run2 = new Run();
		System.out.print(run.equals(run2));
		
		// equals()
		System.out.println(str1.equals(str2));
		// true ==> rkxek
		// 주소값 비교는 물론이고 문자열도 값도 비교하도록 오버라이딩
		...
		// 주소값을 해상하는 것이 아니라 실제 담긴 문자열을 기반으로 해시코드 값을 만들도록 오버라이딩
		
		// 참조형 변수들을 식별할 숭 있는 값을 알아내는법
		...
		public void method4() {
			...
			// 이를 해결하기 위해서 임시공간(Buffer)를 준비해서
			// 임시공간에 차고차곡 담았다가 한번에 처리해주는 클래스
		...
		public void stringMethod() {
			...
			if(answer.toUpperCase().equals("Y") || answer.equals("y")) {
				System.out.println("나 찐으로 해야겠다 참을수 없다.");
			}

...
public class Run {
	...
	public static void main(String[] args) {
		...
		Book book = new Book("그 많던 싱아는 누가 다 먹었을까", "웅진 지식하우스"
				           , "박완서", 16650);
		ElectronicBook eb = new ElectronicBook("저속노화 마인드셋", "웨일북"
				                              ,"정희원", 17550, "yes24");
		PaperBook pb = new PaperBook("혼모노", "창비", "성해나"
				                    , 16200, 0);
		...
		System.out.println(book); // 메소드 호출의 반환값
		System.out.println(book.toString());
		//toString() : 해당 객체의 풀크래스명 + "@" + 해당 객체의 주소값(16진수형) : String

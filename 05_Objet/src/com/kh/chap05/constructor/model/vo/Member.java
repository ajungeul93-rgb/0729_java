...
public class Member {
	...
	//public Member() {}
		...
		// 클래스 내부에 생성자를 하나도 작성하지 않으면 JVM이 기본생성자를 자동으로 만들어1줌
		// 기본생성자를 항상 작성하자!☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠
	
	
	//public member() <-----메소드로 인식
	//public void Member() <-----메소드로 인식
	
	public Member() {} // <-- 애는 무조건 꼭 있어야함!
	 ...
	 * 4. 생성자는 동일한 이름으로 여러 개 생성이 가능하지만 매개변수 중복되어선 안됨! => 생성자 오버로딩
	 * 
	 */

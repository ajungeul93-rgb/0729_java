...
public class Cafe {
	...
	public void setSignatureMenuPrice(int signatureMenuPrice) {
		...
		//System.out.println("입력하신 시그니쳐 메뉴 가격: " + signatureMenuPrice);
	}
	...
	// adderss필드를 기록 및 수정할 수 있는 메소드
	public void setAdderss(String adderss) {
		this.address = adderss;		
	}
	
	/*
	 * 관례 위반 : 두 개 이상의 필드값을 변경하는 메소드는 set이 붙으면 xxx (관례 위반)
	...
	*/
	...
	// getter() / setter() 둘다 만들었다 ==> 캡슐화가 끝남(문법적인 관례)
	/*
	 * 1. 값을 숨긴다 => 필드의 접근제한자를 public대신 private로 선언한다.
	...
	public String info() {
		...
		// return 할 때 반환할 수 있는 값 단 한개 (public (string or int) name(){})

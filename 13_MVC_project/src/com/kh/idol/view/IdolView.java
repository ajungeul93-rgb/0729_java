...
public class IdolView {
	...
	private void infoMenu() {
		...
		System.out.println("5. 모든 멤버의 정보보기");
	...
	private void findAll() {
		...
		if (aespa.isEmpty()) {
			...
			for (Idol i : aespa) {
				...
				System.out.println();
				System.out.println("전투 기술 : " + i.getSkill());
				System.out.println();
				System.out.println("👯‍♂️👯‍♂️👯‍♂️👯‍♂️👯‍♂️👯‍♂️👯‍♂️👯‍♂️👯‍♂️👯‍♂️👯‍♂️👯‍♂️👯‍♂️👯‍♂️👯‍♂️👯‍♂️");
			}
	...
	public void signUp() {
		...
		//Fan이라는 자료형에 맞춰 필드에 Setg할 값 3개를 사용자에게 입력받음
		...
		while(true) {
		     ...
		     // 하지만 지금 이 회원가입 메소드는
		     // 회원가입 뿐만 아니라 아이디값에 대한 유효성 검증을 진행하고 있다.
		     // 1. 유효성 검증
		     // 2. 회원가입
		...
		// 사용자가 입력한 아이디와 비밀번호와 닉네임을 가지고 Fan객체를 생성해서 필드에 담아

...
public class IdolController {
	...
	{
		aespa.add(new Idol("카리나", "리더", "Roket Puncher"));
...
⣟⣷⢿⣽⣟⣯⣿⢷⣟⣷⣟⣾⣳⡿⣯⢿⣽⢾⣻⣽⣟⣿⣳⣟⡷⣯⢷⡽⣼⣺⣯⡷⣵⡵⣿⢾⡷⣿⣵⣟⣿⣽⢾⣯⢷⣿⣻⣾⣻⣽⣯⣷⢿⣯⡿⣿⣾⣻⣿⣽
				...
				""");
		aespa.add(new Idol("지젤", "외국인1", "Xenonglossy"));
...
⣿⡷⣕⢯⡳⣝⣞⡮⡯⣯⡳⡽⣽⡽⣯⣟⣿⡺⣞⣶⢶⣖⣦⣤⣤⣤⣤⡤⣥⢤⣐⣌⣠⣠⡠⣀⣀⢤⣔⢶⣳⢯⣻⡺⡮⣞⡾⡭⣞⣞⡮⣗⡧⡷⣼⢽⢼⢵⢧⣗
	...
	// 2. fan들이 들어가는 List의 3. 요소의 userId필드값과 4. 중복되는게 있는지
	...
	public Fan login(String userId, String userPwd) {
		...
		// 둘다 일치하는 Fan객체가 존재한다면 사용자의 정보가 담겨있는 Fan을 반환
		for(int i = 0; i < fans.size(); i++) {

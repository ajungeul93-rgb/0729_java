...
public class G_Triple {
	/*
	 * 삼항 연산자 : 피 연산자가 3개 => 값 3개와 1개의 연산자로 이루어짐(조건의 형식으로 쓰임)
	 * 
	...
	public void method1() {
		...
		System.out.println("1. 더 멜론 오브 메론 프라프치노");
		...
		String selectedMenu = (menuNo == 1) ? "더 멜론 오브 멜론 프라푸치노를 추문하셨습니다."
	...
	public void think()  {
		...
		char alpa = (('a' <= ch) && (ch <= 'z')) ? '소' : '대';
		
		// 입력받은 알파벳이 소문자인지 / 대문자인지 판별 후 출력해주세요.
				
		System.out.println(ch + "은(는)" + alpa + "문자 입니다.");	
